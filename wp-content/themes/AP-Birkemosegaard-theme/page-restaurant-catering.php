    ...
    <main>
      <section class="introGaardrestaurant">
        ...
        <div class="introGaardrestaurantBillede fade-in">
          <img
            src="./assets/img/introbilledeGaardrestaurant.png"
            alt="billede fra restaurant"
          />
        </div>
      </section>
        ...
        <div class="eventCards">
          <div class="eventCard">
            ...
            <div class="eventBillede">
              <img
                src="./assets/img/Riccardo_1_stor.jpeg"
                alt="billede af riccardo"
              />
            </div>
          </div>
          <div class="eventCard">
            ...
            <div class="eventBillede">
              <img src="./assets/img/Ranees.jpg" alt="billede af riccardo" />
            </div>
          </div>
        </div>
      </section>
      <section class="catering">
        <div class="cateringBillede fade-in">
          <img src="./assets/img/catering_2.jpg" alt="billede fra restaurant" />
        </div>
      ...
      <section class="restaurantGavekort">
      ...
      <section class="hvemErVi">
        ...
        <div class="hvemErViBillede fade-in">
          <img
            src="./assets/img/hvemervi.png"
            alt="billede af Birkemosegaard ejere"
          />
        </div>
      </section>
    </main>
